...
void c_menu::draw(bool is_open)
{
	...
	ImGui::Begin(crypt_str("skeet.pw"), nullptr, ImGuiWindowFlags_NoDecoration);
	{
		...
		ImGui::SetCursorPos(ImGui::GetCursorPos() + ImVec2(850 * dpi_scale - ImGui::CalcTextSize(crypt_str("skeet.pw")).x - (11 * dpi_scale), (16 * dpi_scale) - (ImGui::CalcTextSize(crypt_str("skeet.pw")).y / 2)));

		ImGui::PushStyleColor(ImGuiCol_Text, ImVec4(1.f, 1.f, 1.f, 1.f));
		ImGui::PushStyleVar(ImGuiStyleVar_Alpha, m_alpha);
		ImGui::Text(crypt_str("skeet.pw"));
		ImGui::PopStyleVar();
		ImGui::PopStyleColor();
